...
## 当前焦点
**F2-M3 ✅ 完成**（brk syscall：懒 brk + execve brk_initial + Heap VMA，722/0 + 实机启动不炸，详见 `PLAN.md`/`document/notes/2026-06-17-f2-m3-brk.md`）。下一焦点待定——F2-M4 Page Cache / F4 SMP / F5-M2 VirtIO，或 `/milestone` 拆批。
