/**
 * @file kernel/syscall/sys_creat.hpp
 * @brief sys_creat handler declaration
 *
...
/**
 * @brief Create a new regular file at the given path
 *
 * Resolves the path through the VFS mount table, splits it into
 * parent directory and leaf name, then invokes InodeOps::create()
